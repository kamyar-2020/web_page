...
<div style = "background-image: url('contact.png'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;" id = "Contact"><h3>Cotact Me</h3></div>
